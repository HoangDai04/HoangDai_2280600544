...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                self.ui.txt_ciphertext.setPlainText(data["encrypted_message"])  # Sửa setText thành setPlainText
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
    ...
    def call_api_sign(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                self.ui.txt_signature.setPlainText(data["signature"])  # Sửa setText thành setPlainText
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
